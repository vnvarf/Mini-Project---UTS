...
@section('content')
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-4">
            <img src="{{ Vite::asset('resources/images/1.jpg') }}" class="img-fluid" alt="Gambar 1">
          </div>
          <div class="col-md-4">
            <img src="{{ Vite::asset('resources/images/2.jpg') }}" class="img-fluid" alt="Gambar 2">
          </div>
          <div class="col-md-4">
            <img src="{{ Vite::asset('resources/images/3.jpg') }}" class="img-fluid" alt="Gambar 3">
          </div>
        </div>
        ...
        <div class="container mt-5">
            <div class="row">
              <div class="col-md-4 d-flex justify-content-center">
                ...
                <img src="{{ Vite::asset('resources/images/4.jpeg') }}" class="profile-img img-fluid" alt="Foto Profil">
              </div>
              <div class="col-md-8" >
                <h2>Biodata</h2>
                <ul class="list-group">
