...
?>
    ...
    <nav style="background-color: rgb(255, 184, 195); color: rgb(67, 200, 200);" class="navbar navbar-expand-md navbar-dark ">
        <div class="container">
            <a href="<?php echo e(route('home')); ?>" class="navbar-brand mb-0 h1"><i class="bi bi-gem me-2"></i> Sapphrodite.id</a>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/UTS-MasterBarangVanva/resources/views/layouts/nav.blade.php ENDPATH**/ ?>